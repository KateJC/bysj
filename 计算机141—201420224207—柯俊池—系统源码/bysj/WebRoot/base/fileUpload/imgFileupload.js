~(function (win) {
    var clickNum = 0;
    var htmls = '<input type="file" name="file" class="imgFiles" style="display:none;" accept="image/gif,image/jpeg,image/jpg,image/png,image/svg" multiple>' +
        '<div class="header">' +
        '    <span class="imgClick">' +
        '    </span>' +
        '</div>' +
    ...
    ImgFileupload.prototype.init = function () {
        ...
        this.dom.innerHTML =
            '    <img src="/bysj/base/img/login.gif" alt="" data-src="' + this.imgSrc + '" class="imsg">' +
            '    <i class="delImg">' +
            '        X' +
            '    </i>';
